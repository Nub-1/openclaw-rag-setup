...
2. [การติดตั้ง Qdrant บน Unraid](#2-การติดตั้ง-qdrant-บน-unraid)
3. [การตั้งค่า OpenAI API](#3-การตั้งค่า-openai-api)
4. [การติดตั้ง Python และ Dependencies](#4-การติดตั้ง-python-และ-dependencies)
5. [การทำ OCR ด้วย OpenAI Vision](#5-การทำ-ocr-ด้วย-openai-vision)
6. [การทำ Embedding และเก็บใน Qdrant](#6-การทำ-embedding-และเก็บใน-qdrant)
7. [การค้นหาข้อมูล](#7-การค้นหาข้อมูล)
8. [การแก้ไขปัญหาที่พบบ่อย](#8-การแก้ไขปัญหาที่พบบ่อย)
9. [Use Cases และตัวอย่าง](#9-use-cases-และตัวอย่าง)
10. [เครดิต](#10-เครดิต)
